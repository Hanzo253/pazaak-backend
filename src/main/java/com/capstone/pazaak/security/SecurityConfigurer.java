...
public class SecurityConfigurer extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/auth/users", "/auth/users/login", "/auth/users/register", "/auth/users/list", "/auth/users/{username}", "/auth/users/delete", "/auth/users/changepassword", "/auth/users/wins", "/auth/users/losses").permitAll()
